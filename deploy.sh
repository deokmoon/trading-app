...
nohup /opt/java/openjdk/bin/java -jar -Dspring.config.location=classpath:/application-$IDLE_PROFILE.yml -Dspring.profiles.active=$ACTIVE_PROFILE $JAR_NAME > nohup.out 2>&1 &
